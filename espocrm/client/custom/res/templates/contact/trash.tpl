<div class="nexa-restore-workspace">
    <header class="nexa-restore-header">
        <div>
            <h2>Restore records</h2>
            <p>Review and restore Contact records deleted during the two-month recovery window.</p>
        </div>
        <button class="btn btn-default" data-action="back"><span class="fas fa-arrow-left" aria-hidden="true"></span> Back to Contacts</button>
    </header>

    <section class="nexa-restore-filters" aria-label="Deleted record filters">
        <label class="nexa-restore-search">
            <span>Search records</span>
            <span class="nexa-restore-input-wrap"><span class="fas fa-search" aria-hidden="true"></span><input class="form-control" type="search" data-name="search" placeholder="Search name or email" autocomplete="off"></span>
        </label>
    ...
    <section class="nexa-restore-results" aria-labelledby="nexa-restore-results-heading">
        <div class="nexa-restore-results-heading">
            <div><h3 id="nexa-restore-results-heading">Deleted contacts</h3><p data-name="resultCount">Loading records...</p></div>
        ...
        <div class="table-responsive nexa-restore-table-wrap">
            <table class="table nexa-restore-table">
                <thead><tr><th class="nexa-restore-check"><input type="checkbox" data-name="selectAll" aria-label="Select all visible records"></th><th>Name</th><th>Deleted by</th><th>Date deleted</th></tr></thead>
                <tbody data-name="records"><tr><td colspan="4" class="nexa-restore-empty">Loading deleted records...</td></tr></tbody>
            </table>
        </div>
    </section>
</div>
