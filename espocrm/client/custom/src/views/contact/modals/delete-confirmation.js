define('custom:views/contact/modals/delete-confirmation', ['views/modal'], Dep => class extends Dep {
    template = 'custom:contact/modals/delete-confirmation';
    ...
    actionDelete() {
        const value = Number(this.element.querySelector('[data-name="confirmationCount"]')?.value);
